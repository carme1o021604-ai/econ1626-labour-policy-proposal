...
The employment impact of AI is likely to be uneven. Current evidence suggests that the main issue is task transformation rather than simple job replacement. Jobs and Skills Australia finds that Gen AI has greater potential to augment work than automate it, although higher automation potential is concentrated in routine clerical and administrative roles (Jobs and Skills Australia 2025). This means the labour market effect will depend on how saved time is used. If firms use AI to increase output or improve service quality, employment may be maintained or even expanded. If firms use AI mainly to reduce labour hours, some workers may face displacement.
